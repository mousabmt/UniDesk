...
class StudentWaveHeaderCard extends StatelessWidget {
            ...
            children: [
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: CustomPaint(painter: const StudentWavePainter()),
                ),
              ),
              Padding(
...
class StudentWavePainter extends CustomPainter {
  const StudentWavePainter();
